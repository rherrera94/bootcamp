...
export async function getServerSideProps({ params }) {
    /**
     * Solicito los datos de la empresa que me llegan en la url y segun ese id
     * devuelvo la empresa que esta registrada con ese id y tambien las busquedas
     * de empleo que tiene a su nombre.
     */
    let company = await getCompany(params.id, prisma);
    let jobs = await getCompanyJobs(params.id, prisma);//devuelve array
